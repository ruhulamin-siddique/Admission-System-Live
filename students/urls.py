...
urlpatterns = [
    ...
    path('students/cancel-residency/<str:student_id>/', views.cancel_hall_residency, name='cancel_hall_residency'),
    ...
    path('reports/halls/', views.hall_reports_dashboard, name='hall_reports_dashboard'),
    ...
    path('api/revert-changes-bulk/', views.bulk_revert_field_changes, name='bulk_revert_field_changes'),
